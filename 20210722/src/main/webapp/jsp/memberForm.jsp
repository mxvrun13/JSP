			...
			<form id="frm" name="frm" action="memberInsert.jsp" method="post">
				<div>
					<table border="1">
						...
						<tr>
							<th width="200">취 미</th>
							<td width="300"><input type="checkbox" id="hobby"
								name="hobby" value="등산">등산 <input type="checkbox"
								id="hobby" name="hobby" value="낚시">낚시 <input
								type="checkbox" id="hobby" name="hobby" value="당구">당구 <input
								type="checkbox" id="hobby" name="hobby" value="바둑">바둑 <input
								type="checkbox" id="hobby" name="hobby" value="여행">여행</td>
						</tr>
					</table>
				</div>
				<br />
